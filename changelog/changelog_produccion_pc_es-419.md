****************************************************************************************************
24/02/2026 03:02 - Generación de Imágenes por IA, Mejoras Narrativas y Control - Beta_v058
****************************************************************************************************
- What's New (ES-419):
  ...
  **Creación de Personaje:**
  ...
  - 🎲 **Generación Aleatoria Confiable:** Corregido un fallo donde el botón "Generar con IA" podía fallar en el primer intento, dejando los campos vacíos. Ahora el sistema de corrección inteligente se asegura de que la respuesta sea siempre válida.
  ...
  **Gestión de Imágenes Generadas:**
  ...
  - 🗑️ **Borrado Selectivo:** Selecciona una o varias imágenes y elimínalas si no te convencen (quizás esa en la que la IA decidió que era buena idea estacionar un autobús en el establo del castillo). El sistema limpia tanto el archivo como su registro interno.
  ...
  **Rendimiento en Configuraciones Bajas (Importante para GPU con poca VRAM):**
  - 🧠 **PSR - Gobernanza Híbrida:** Nuevo sistema que divide el trabajo de la IA en dos fases: Planificación (Chef) y Ejecución (Cocineros). Esto permite que modelos locales con 8 GB de VRAM funcionen evitando colapsos por exceso de contexto (+12K tokens), a costa de una latencia mayor; la interacción con la IA pasa de ser un único prompt a una serie de prompts (cuanto menor sea la VRAM mayor cantidad de prompts se generarán y mayor tiempo de respuesta).
  ...
  **Voces IA (mejora incremental):**
  Generación en tiempo real de voces en todos los idiomas (algunos idiomas están más limitados que otros, el más variado en tipos de voces es el inglés)
  ...
  - 🔊 **Mayor Claridad al Escuchar:** Se mejora la inteligibilidad y la prosodia de la síntesis para priorizar una dicción comprensible.
...
- Novedades (ES):
  **Sistemas y Rendimiento:**
  - 🧠 **Control Total de Contexto:** Ahora puedes ajustar tanto la memoria de la IA (`n_ctx`) como la longitud de sus respuestas (`Max Tokens`) con sliders mucho más intuitivos.
  - ♾️ **Modo Ilimitado:** Desliza al mínimo para activar el modo "Ilimitado", dejando que modelos potentes como Gemini usen toda su capacidad sin restricciones.
  - ⚡ **Reinicio de Drivers:** Nueva opción en el lanzador para reiniciar los controladores de vídeo antes de jugar (opcional, configurable desde launcher), ahora al iniciar la pantalla parpadeará, con esto nos aseguramos que toda la vram esté disponible, purgándola de residuos.
  ...
  - 🚀 **Mejor Detección de Errores:** El juego ahora es más inteligente detectando cuándo una IA externa se queda sin espacio.
  
  **Mecánicas y Mundo:**
  - 🎒 **Inventario Garantizado:** Se acabó empezar una aventura y no ver tus objetos. El sistema SDIA ahora vigila también la creación del personaje para que tu equipo siempre esté ahí.
  - 📜 **Lore Purificado:** Reparado un fallo que inyectaba fragmentos de "código" o texto extraño en la historia de tu mundo. Ahora el Códice será más puro y legible.
  - ⚠️ **Guía de Compatibilidad:** Incluidos avisos en la configuración para ayudarte a elegir modelos compatibles (Instruct/Chat).
  - ⚙️ **Implantes Fiables:** Corregida la definición de slots y la carga de reglas en la creación de personajes. Ahora todas tus ciber-mejoras usarán slots oficiales y se auto-equiparán correctamente.
...
****************************************************************************************************
14/02/2026 05:06 - Refuerzo de Integridad, Consciencia de Personajes y Optimiza - Beta_v055
****************************************************************************************************
- Novedades (ES):
