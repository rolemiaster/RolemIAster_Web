****************************************************************************************************
31/01/2026 07:36 - Multi-GPU, Correção de Manuais & Estabilidade - Alfa_v051
****************************************************************************************************
- What's New (PT):
  - Novidades:
    ...
    * **📖 Manuais Web Dinâmicos:**
      * **Seletor Real:** O menu de idiomas agora verifica quais arquivos realmente existem antes de exibi-los. *Fim das opções fantasma que não faziam nada; magia de adivinhação nível 5.*
