****************************************************************************************************
31/01/2026 07:14 - Multi-GPU, Manual Fixes & Stability - Alfa_v052
****************************************************************************************************
- What's New (EN):
  - What's New:
    ...
    * **🛡️ Stability:** Added all missing DLL libraries to prevent unexpected crashes. *I've armored the engine. If it fails now, it's a critical fumble on the dice.*
    * **📖 Dynamic Web Manuals:**
      * **Real Selector:** The language menu now verifies which files actually exist before showing them. *No more ghost options that did nothing; Level 5 Divination magic.*
      * **Error 403 Fix:** Fixed the permission error that prevented viewing the Changelog in-game. *I've taught the app to ask for entry correctly ("Open Sesame!").*
