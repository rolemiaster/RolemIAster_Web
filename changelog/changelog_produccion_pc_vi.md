****************************************************************************************************
17/02/2026 19:18 - Tạo hình ảnh bằng AI, Cải thiện Cốt truyện và Điều khiển - v058
****************************************************************************************************
- What's New (VI):
  **⚠️ NHÁNH THỬ NGHIỆM (BETA TRÊN STEAM)**
  ...
  3. Chuyển đến tab **Betas**.
  4. Tại mục "Beta Participation", chọn **experimental** trong danh sách thả xuống.
  **Tính năng mới: Giai đoạn đầu của Tạo hình ảnh bằng AI**
  - 🎨 **Thế giới của bạn qua Hình ảnh:** Tôi đã tích hợp một hệ thống tạo hình ảnh ban đầu bằng Trí tuệ Nhân tạo. Khi bạn chơi, hệ thống sẽ cố gắng tạo ra các bức chân dung và phong cảnh phù hợp với bối cảnh trò chơi của bạn.
  - 🖼️ **Hình nền Động:** Hình ảnh được tạo trong nền mà không làm gián đoạn trò chơi của bạn. Bạn sẽ thấy chúng dần xuất hiện ở hình nền, trên thẻ nhân vật và trong Codex.
  - ⚡ **Tốc độ tùy chỉnh:** Mục mới trong Cài đặt Hình ảnh. Chọn giữa "Nhanh" (1 bước), "Trung bình" (2 bước) hoặc "Cao" (4 bước) để điều chỉnh thời gian tạo hình ảnh phù hợp với sức mạnh máy tính của bạn.
  - 🛠️ **Tối ưu hóa Kỹ thuật:** Mô hình AI cho hình ảnh được tải vào **RAM (Bộ nhớ)** và xử lý qua **CPU**, không chiếm dụng bộ nhớ video (VRAM). Điều này đảm bảo nó không ảnh hưởng đến hiệu suất của AI chính trong trò chơi (LLM). Yêu cầu thêm khoảng 5GB RAM, vẫn nằm trong mức cấu hình tối thiểu chính thức trên Steam.
  - 📤 **Chia sẻ Cuộc phiêu lưu:** Tất cả hình ảnh được tạo sẽ tự động được lưu lại. Bạn có thể tìm thấy chúng trong thư mục: `%APPDATA%/RolemIAster/custom_assets/images`
  - 🔬 **Bộ chọn Mô hình (Nâng cao):** Nếu bạn khởi động trò chơi với tham số `--advanced`, giờ đây bạn có thể chọn mô hình AI nào để sử dụng cho hình ảnh từ bảng Giao diện. Điều này cho phép những người đam mê thử nghiệm các phiên bản Stable Diffusion khác nhau đã được tối ưu hóa cho OpenVINO (các tệp .xml/.bin).
  **Cốt truyện và Bộ não AI:**
  - 🧠 **Chấm dứt Vòng lặp:** Một "Học thuyết Bộ nhớ" mới đã được triển khai trong AI. Giờ đây nó phân biệt tốt hơn giữa "ký ức" (những gì đã xảy ra) và "hiện tại" (những gì đang diễn ra). Điều này giúp giảm các trường hợp AI tự lặp lại hoặc bị kẹt.
  - 📜 **Lưu trữ Lịch sử:** Hệ thống trình bày ký ức của bạn cho AI dưới dạng một "Lưu trữ Lịch sử Đóng", giúp nó dễ dàng sử dụng thông tin đó làm tài liệu tham khảo để phát triển câu chuyện.
  - ⚡ **Hướng dẫn Tối ưu hóa:** Cách trò chơi yêu cầu kể chuyện bằng ngôn ngữ của bạn đã được cải thiện, giải phóng dung lượng mô hình để tập trung vào sự sáng tạo.
  - 👁️ **Tiêu điểm Cốt truyện:** Nhận thức của AI đã được viết lại. Giờ đây nó hiểu rõ hơn những yếu tố nào là "nền tĩnh" và không nên lặp lại chúng một cách không cần thiết trong mỗi đoạn văn.
  - 🔀 **Quyết định Rõ ràng hơn:** AI hiện cung cấp các hướng đi rõ ràng hơn. Các đề xuất (nút bấm) được chia thành điều tra môi trường (Đi sâu) hoặc thay đổi hướng đi (Rẽ nhánh).
  - 🫵 **Xưng hô Trực tiếp:** Hướng dẫn cơ bản đã được điều chỉnh để đảm bảo AI xưng hô với bạn là "Bạn", giúp tăng cường sự nhập vai cá nhân.
  **Tạo Nhân vật:**
  - 🖼️ **Chân dung Nhân vật:** Khi tạo nhân vật bằng AI, hệ thống sẽ cố gắng tạo chân dung dựa trên tuổi, nghề nghiệp và mô tả. Lưu ý rằng đây là phiên bản ban đầu và độ chính xác (đặc biệt là về tuổi tác) có thể thay đổi tùy theo mô hình được sử dụng. (tôi vẫn đang thử nghiệm nhưng khởi đầu khá tốt)
  - 🎲 **Tạo Ngẫu nhiên Đáng tin cậy:** Đã sửa lỗi nút "Tạo bằng AI" có thể bị lỗi trong lần thử đầu tiên, khiến các trường bị để trống. Giờ đây, hệ thống sửa lỗi thông minh đảm bảo rằng phản hồi luôn hợp lệ.
